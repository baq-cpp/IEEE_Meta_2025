    ...
    public void TileSelected(GameObject SelectedTile)
    {
        ...
        else if (_SecondSelected == null && SelectedTile != _FirstSelected)
        {
            ...
            else
            {
                ...
                Wire.Connect(Component2.ParseOrderedPair(_FirstSelected.name),Component2.ParseOrderedPair( _SecondSelected.name),_FirstSelected.name + _SecondSelected.name, Breadboard.Instance, "G2G");
